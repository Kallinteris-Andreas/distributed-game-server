	...
	<html>
	 ...
	 <body>
		...
		function getPlayState(){
			...
			//exec game.load(newfen)
			//exec board.position(game.fen)
			//exec updateStatus(null)
			//if not my turn and not game over exec getPlayState again in 1sec
			//if game over and my turn inform game master its over
		}
